...
load frc_wofriction
FRCSSMTool_1 = FRCSSMTool_data{1,1};
FRCSSMTool_2 = FRCSSMTool_data{1,2};
FRCSSMTool_3 = FRCSSMTool_data{1,3};
...
customFigure()
hold on
legend('frictionless stable - SSMTool','frictionless unstable - SSMTool')
xlim([omegaSpan(1) omegaSpan(2)]);
ylim([0 8e-3]);
...
% amplitude 25
customFigure()
plotFRC(FRCSSMTool_data{1,1}, colors(2,:), '- SSMTool')
plot(FRC_full{2,1},FRC_full{1,1},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'DisplayName','Full model');
plot(FRC_full_reverse{2,1},FRC_full_reverse{1,1},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'HandleVisibility','off');
plot(FRC_reduced{2,1},FRC_reduced{1,1},'.g','MarkerSize',12,'DisplayName','Reduced model');
plot(FRC_reduced_reverse{2,1},FRC_reduced_reverse{1,1},'.g','MarkerSize',12,'HandleVisibility','off');

xlim([FRCSSMTool_data{1,1}.F1.Freq(1) FRCSSMTool_data{1,1}.F1.Freq(end)]);
ylim([0 8e-3])

% amplitude 30
customFigure()
plotFRC(FRCSSMTool_data{1,2}, colors(2,:), '- SSMTool')
plot(FRC_full{2,2},FRC_full{1,2},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'DisplayName','Full model');
plot(FRC_full_reverse{2,2},FRC_full_reverse{1,2},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'HandleVisibility','off');
plot(FRC_reduced{2,2},FRC_reduced{1,2},'.g','MarkerSize',12,'DisplayName','Reduced model');
...
% amplitude 35
customFigure()
plotFRC(FRCSSMTool_data{1,3}, colors(2,:), '- SSMTool')
plot(FRC_full{2,3},FRC_full{1,3},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'DisplayName','Full model');
plot(FRC_full_reverse{2,3},FRC_full_reverse{1,3},'k','Marker','o','linestyle','none','MarkerSize',12,'linewidth',3,'HandleVisibility','off');
plot(FRC_reduced{2,3},FRC_reduced{1,3},'.g','MarkerSize',12,'DisplayName','Reduced model');
